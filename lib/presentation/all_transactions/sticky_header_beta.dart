...
class _AllTxnHistoryViewState extends State<AllTxnHistoryView> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      ...
      appBar: CustomAppBar(
        title: Text("Transaction History", style: get20TextStyle()),
      ),
      body: Column(
        children: [
          Expanded(
            child: ListView(
              ...
              padding: EdgeInsets.only(
                  left: 16, right: 16, top: isSmallScreen(context) ? 10 : 24),
              children: [
                SizedBox(
                  height: 130,
                    ...
                    child: Row(
                      children: [
                        buildStatsWidget(
                          ...
                          titleValue: formatTopbarValues(
                              txnHistoryProvider.getTotalTxnCount()),
                          desc: "Value:",
                          descValue: formatTopbarValues(
                              txnHistoryProvider.getTotalTxnAmount()),
                          color: ColorManager.kSecBlue,
                          titleStyle: get12TextStyle().copyWith(
                            color: ColorManager.kWhite,
                            fontWeight: FontWeight.w400,
                          ),
                          valueStyle: get20TextStyle().copyWith(
                            color: ColorManager.kWhite,
                            fontWeight: FontWeight.w500,
                          ),
                        ),
                        buildStatsWidget(
                          title: "Giftcards Sold:",
                          titleValue: formatTopbarValues(txnHistoryProvider
                              .getGiftCardPartailAndApprovedSoldCount()),
                          desc: "Value:",
                          descValue: formatTopbarValues(txnHistoryProvider
                              .getGiftCardPartailAndApprovedSoldAmount()),
                          color: ColorManager.kGiftcardTab1,
                        ),
                        buildStatsWidget(
                          title: "Giftcards Bought:",
                          titleValue: formatTopbarValues(txnHistoryProvider
                              .getGiftCardPartailAndApprovedBuyCount()),
                          desc: "Value:",
                          descValue: formatTopbarValues(txnHistoryProvider
                        ...
                        buildStatsWidget(
                          title: "Crypto Sold:",
                          titleValue: formatTopbarValues(txnHistoryProvider
                              .getCryptoPartailAndApprovedSoldCount()),
                          desc: "Value:",
                          descValue: formatTopbarValues(txnHistoryProvider
                        ...
                        buildStatsWidget(
                          title: "Crypto Bought:",
                          titleValue: formatTopbarValues(txnHistoryProvider
                              .getCryptoPartailAndApprovedBuyCount()),
                          desc: "Value:",
                          descValue: formatTopbarValues(txnHistoryProvider
                              .getCryptoPartailAndApprovedBuyAmount()),
                  ...
                  content: RefreshIndicator(
                    ...
                    child: fetching
                        ? ListView(
                            ...
                            children: [
                              SquareShimmer(width: double.infinity, height: 50),
                            ...
                            ? ListView(
                                ...
                                children: const [
                                  NoContent(
                                    displayImage: true,
                                    desc:
                                        "Please try different search param(s)",
                                  ),
                                ],
                              )
                            : GroupedListView<AllTxnHistory, String>(
                                shrinkWrap: true,
                                physics: ClampingScrollPhysics(),
                                ...
                                itemBuilder: (c, el) {
                                  return AllTransactionTile(
                                    ...
                                    onTap: () {
                                      if (el.type ==
                                          Constants.kCryptoTxnTypeValue) {
                                        Navigator.pushNamed(
                                            context,
                                            RoutesManager
                                                .cryptoTxnHistoryDetails,
